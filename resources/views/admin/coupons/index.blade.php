...
@section('admin')
    ...
    <div class="container-fluid row">
        ...
        <div class="col-12 col-lg-12 col-xl-4">
            <button id="toggleFormBtn" class="btn btn-primary mb-3">Thêm</button>
                    ...
                    <form action="{{ route('coupons.store') }}" id="formAddCoupon" method="post">
                        ...
                        <div class="form-group row mb-0">
                            <label for="discount" class="col-12 control-label col-form-label">Tỉ lệ (%)
                                <span class="text-danger">*</span> </label>
                            <div class="col-12">
                                <input type="text" class="form-control" name="discount" id="discount" placeholder="Tỉ lệ">
                                <p class="text-danger" id="errorDiscount"></p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <label for="number" class="col-12 control-label col-form-label">Số lượng
                                <span class="text-danger">*</span> </label>
                            <div class="col-12">
                                <input type="text" class="form-control" name="number" id="number" placeholder="Số lượng">
                                <p class="text-danger" id="errorNumber"></p>
                            </div>
                        </div>
        
                        <div class="form-group row mb-0">
                            <label for="startDate" class="col-12 control-label col-form-label">Ngày bắt đầu
                                <span class="text-danger">*</span> </label>
                            <div class="col-12">
                        ...
                        <div class="form-group row mb-0">
                            <label for="endDate" class="col-12 control-label col-form-label">Ngày kết thúc
                                <span class="text-danger">*</span> </label>
                            <div class="col-12">
                                <input type="datetime-local" class="form-control" min="{{ date('Y-m-d\TH:i') }}"
                                       name="end_date" id="endDate">
                        ...
                        <div class="form-group row mb-0">
                            <label for="status" class="col-12 control-label col-form-label">Trạng thái</label>
                            <div class="col-12 d-flex align-items-center">
                                <div>
                                    @include('components.button_switch',['status' => 1,'id' => 'statusCoupon'])
                                </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-info mb-3">Thêm mã</button>
                        </div>
