                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title d-flex justify-content-between align-items-center">
                                ...
                                @if($booking->is_payment == PAYMENT_UN_PAID && $booking->status != BOOKING_COMPLETE || $booking->total > $booking->deposit)
            ...
            <div class="modal-content">
                <form id="formEditDeposit">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel">Thanh toán</h5>
