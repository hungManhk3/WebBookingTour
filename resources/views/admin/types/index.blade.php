...
@section('admin')
    ...
    <div class="container-fluid row">
        ...
        <div class="container">
            ...
            <div id="newTypeFormContainer" class="row mt-3" style="display: none;">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('types.store') }}" id="formAddType" method="post">
                                ...
                                <div class="form-group row mb-0">
                                    <label for="name" class="col-12 control-label col-form-label">
...
<script>
    document.getElementById('btnAddType').addEventListener('click', function () {
        const typeFormContainer = document.getElementById('newTypeFormContainer');
        if (typeFormContainer.style.display === 'none') {
