...
@section('admin')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h2 class="page-title">Điểm đến</h2>
    ...
    <div class="container-fluid row">
        ...
        <div class="container">
            ...
            <!-- Form ban đầu được ẩn -->
            <div id="newFormContainer" class="row mt-3" style="display: none;">
                <div class="col-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('destinations.store') }}" id="formAddDestination" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="name" class="text-left control-label col-form-label">
                                        Tên điểm đến<span class="text-danger">*</span>
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Tên điểm đến" value="{{old('name')}}">
                                    </div>
                                    <p class="text-danger" id="errorName"></p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="slug" id="slug" placeholder="Rút gọn">
                                    </div>
                                    <p class="text-danger" id="errorSlug"></p>
                                </div>
...
<script>
    document.getElementById('btnAddNew').addEventListener('click', function () {
        const formContainer = document.getElementById('newFormContainer');
