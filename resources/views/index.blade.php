...
@section('content')
    <div class="box-banner-header" id="boxBanner">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 statistical-item">
                        ...
                        <div class="statistical-content">
                            <p class="title">100+ ĐỊA ĐIỂM HẤP DẪN</p>
                            <p class="content">Những địa điểm du lịch đẹp nhất của 63 tỉnh thành Việt Nam</p>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 statistical-item">
                        ...
                        <div class="statistical-content">
                            ...
                            <p class="content">Liên hệ thỏa thuận giá cả trong vòng 24 giờ sau khi xác nhận đơn</p>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 statistical-item">
                        ...
                        <div class="statistical-content">
                            ...
                            <p class="content">Chúng tôi sẵn sàng hỗ trợ mọi thắc mắc mọi lúc mọi nơi.</p>
                        </div>
                    </div>
                </div>
            </div>
     ...
     <div class="popular-tour container">
        <div class="box-title">
            <p class="title">Danh sách tour</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <p class="price" style="margin-right: 0.5rem;">{{ number_format($tour->price) }}đ</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="destinations">
            <div class="row">
                @foreach ($destinations as $destination)
                    <div class="col-12 @if ($loop->first) col-lg-4 @else col-lg-4 @endif destination-item">
    ...
    {{-- <div class="ads container">
        <div class="row">
            <div class="col-6 ads-left">
                <p>Tận hưởng kì nghỉ lí tưởng cùng chúng tôi</p>
                <span>Ưu đãi lên tới 40%</span>
            </div>
            <div class="col-6 ads-right">
                <img src="{{ asset('images/bg-hanoi.png') }}" alt="ads tour">
            </div>
        </div>
    </div>  --}}
