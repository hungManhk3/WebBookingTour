<nav class="navbar top-navbar navbar-expand-md navbar-dark">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
            ...
            <span class="logo-text" style="margin-left: 20px;">
                 <!-- dark Logo text -->
                 <img height="40" src="{{ asset('images/logo-mixi.png') }}" alt="homepage" class="dark-logo"/>
    ...
    <!-- End Logo -->
    <!-- ============================================================== -->
    <div class="navbar-collapse collapse" id="navbarSupportedContent" style="background-color: #4b7697">
        <!-- ============================================================== -->
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                        src="{{ asset('admins/assets/images/users/d3.jpg') }}" alt="user" class="rounded-circle"
                        width="31"></a>
